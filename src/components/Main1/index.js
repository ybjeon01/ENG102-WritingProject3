...
function Main1({indexv, indexh}) {
  ...
  return (
    <section data-background-color={CSS["slide-backgroundColor"]}>
      <div className="main1-title" ref={title}>
        <div></div>

        <p>
          Chapter 1<br/>
          The Emergence Of a Global Platform    
        </p>
      </div>
      ...
      <CardController
        ...
        stateRef={controller}
      >
        <div className="main1-container" ref={container}>
          <Explanation />
        </div>
      </CardController>
