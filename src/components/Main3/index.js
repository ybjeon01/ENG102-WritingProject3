...
function Main3({indexv, indexh}) {
  ...
  return (
    <section data-background-color={CSS["slide-backgroundColor"]}>
      <div className="main3-title" ref={title}>
        <div></div>

        <p>
          Chapter 3<br/>
          What Did Entertainment Companies Do? 
        </p>
      </div>
      ...
      <CardController
        ...
        stateRef={controller}
      >
        <div className="main3-container" ref={container}>
          <Explanation />
        </div>
      </CardController>
